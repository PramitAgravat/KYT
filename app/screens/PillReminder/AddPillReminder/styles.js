...
const styles = StyleSheet.create({
    ...
    textInputStyle: { fontFamily: FONT_BOLD, fontSize: 16, color: "#439EAD", borderWidth: 2, borderColor: '#9CE1E5', borderRadius: 50, width: Dimensions.get('window').width * .80, height: 40, paddingLeft: 25, paddingVertical: 0 },
    input: {
