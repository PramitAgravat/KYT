...
const styles = StyleSheet.create({
    ...
    dateTextView: { justifyContent: 'center', alignItems: 'center', marginVertical: 2 },
    dateText: { fontFamily: FONT_BOLD, fontSize: 18 },
    medicineContent: { flexDirection: 'row', marginHorizontal: 10, marginBottom: 5 },
    medicineColor: { borderRadius: 30, width: 30, height: 30 },
    medicineData: { marginLeft: 20, },
    medicineName: { fontFamily: FONT_BOLD, fontSize: 16 },
    scheduledTime: { fontFamily: FONT_REGULAR, fontSize: 16, marginHorizontal: 5 },
    contentView: {
        height: 80,
        alignSelf: 'center',
        // flexDirection: "row",
    ...
    flatListView: { backgroundColor: 'transparent', alignContent: 'center', top: -30 },
    ...
    infoAlertContent: { fontFamily: FONT_REGULAR, alignSelf: 'center', fontSize: 16, marginVertical: 5 },
