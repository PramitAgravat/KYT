...
import PillDetailHead from './Components/PillCard/PillDetailHead';
import PillDetailBody from './Components/PillCard/PillDetailBody';
...
export default class HowFeelView extends Component {
    ...
    renderFrontface() {
        if (!this.state.expanded) {
            return (
                <PillCard onPress={this.flip} data={this.props.data} />
            );
        } else {
            return null;
        }
    ...
    renderBackface() {
        ...
        return (
            <PillDetailBody onPillDelete={(data) => this.onPillDelete(data)} onPress={(val, data) => this.handlePress(val, data)} data={this.props.data} />
        );
    }

    handlePress = (navigateTo, data) => {
        console.log("Pill Reminder Id-------->", data)
        navigateTo({ pill_reminder_id: data })
    }
    onPillDelete = (value) => {

        let params = {
            id: value.pill_reminder_id
        }
        this.props.deletePillReminder(params);
    }
        ...
        return (
            ...
            >
                ...
                >
                    ...
                    >
                        <PillDetailHead data={this.props.data} onPress={this.flip} />
                    </FoldView>
