...
class FixedViewAlertDialog extends Component {
    ...
    setModalVisible(visible, buttonIdx = null) {
        if (!visible && this.props.callBackFunctionOnClose !== undefined && this.props.callBackFunctionOnClose !== null && this.props.callBackFunctionOnClose !== '') {
            this.props.callBackFunctionOnClose();
        }
