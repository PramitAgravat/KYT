...
JNIEXPORT jobject JNICALL Java_com_kyt_pdfscanner_main_ScannerEngine_getScannedBitmap
...
JNIEXPORT jobject JNICALL Java_com_kyt_pdfscanner_main_ScannerEngine_getMagicColorBitmap
...
JNIEXPORT jobject JNICALL Java_com_kyt_pdfscanner_main_ScannerEngine_getBWBitmap
(JNIEnv *env, jobject thiz,jobject bitmap)
{
...
JNIEXPORT jobject JNICALL Java_com_kyt_pdfscanner_main_ScannerEngine_getGrayBitmap
(JNIEnv *env, jobject thiz,jobject bitmap)
{
...
JNIEXPORT jfloatArray JNICALL Java_com_kyt_pdfscanner_main_ScannerEngine_getPoints
(JNIEnv *env, jobject thiz,jobject bitmap)
{
